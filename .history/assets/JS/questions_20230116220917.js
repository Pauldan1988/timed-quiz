...
//Extract text content of button and store it in a variable    //Compair with correct answer of current/displayed question
    //Using an if else statement to check if the user gets a correct/incorrect answer. 
    //What behavior the timer will exhibit(If it will increment or decriment