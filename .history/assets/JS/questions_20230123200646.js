...
let scriptParams = new URLSearchParams(document.location.search)
let quizPage = scriptParams.get("startButton")

let quizDisplay = document.getElementById("questions")
//@ts
quizDisplay.textContent = quizPage
