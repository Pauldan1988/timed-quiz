...
answerContainer.addEventListener("click", checkAnswer => {
    ...
    //Using an if else statement to check if the user gets a correct/incorrect answer. What behavior the timer will exhibit(If it will increment or decriment)
})
