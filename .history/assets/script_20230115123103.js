...
function displayQuestion() {
    ...
    document.querySelector("#q2").innerText = questions[questionIndex].choices[0]
    document.querySelector("#q3").innerText = questions[questionIndex].choices[0]
    document.querySelector("#q4").innerText = questions[questionIndex].choices[0]
}
